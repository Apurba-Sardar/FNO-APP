    ...
    def evaluate(
        ...
        *,
        ...
        checks = [
            ...
            GateCheck(name="DAILY_PROFIT_GOAL", passed=not daily_profit_reached, detail=f"daily profit target (${getattr(self.config, 'max_daily_profit_target', 6.0):.2f}) reached; trading paused to secure daily earnings"),

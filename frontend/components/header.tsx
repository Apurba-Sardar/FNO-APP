      ...
      <div className="mx-auto max-w-[1600px] px-3 sm:px-6">
        <div className="flex h-14 items-center justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2.5 text-xs">
            ...
            {/* Master Settings & Kill Switch Button */}
            <Link
              href="/settings"
              title="Master Settings & Emergency Kill Switch"
              className={`flex items-center gap-1.5 rounded-xl border px-2.5 py-1.5 font-bold transition shadow-sm ${
                pathname.startsWith("/settings")
                  ? "border-amber-500/50 bg-amber-500/10 text-amber-300 shadow-[0_0_15px_rgba(245,158,11,0.2)]"
                  : "border-white/[0.08] bg-[#0c0c10] text-zinc-400 hover:text-white hover:border-white/[0.16]"
              }`}
            >

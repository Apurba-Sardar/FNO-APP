...
export default function Home() {
  return <main className="mx-auto max-w-7xl p-4 sm:p-6">
    <header className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <span className="w-fit rounded-full border border-amber-500/40 bg-amber-500/10 px-3 py-1 text-xs font-semibold text-amber-300">READ ONLY · PHASE 2</span>
    </header>
    ...
    <Link className="mt-6 inline-flex rounded-lg bg-cyan-500 px-4 py-2 text-sm font-semibold text-slate-950" href="/market-data">Open market-data developer page</Link>
  </main>;
}
